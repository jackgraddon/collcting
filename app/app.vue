...
<template>
  <UApp>
    <div
      v-if="isBeta"
      class="bg-amber-500/10 border-b border-amber-500/20 text-amber-600 dark:text-amber-400 text-center text-xs py-1.5 px-4 pl-[max(1rem,env(safe-area-inset-left))] pr-[max(1rem,env(safe-area-inset-right))] pt-[var(--safe-area-top,env(safe-area-inset-top))]"
    >
    ...
    <UMain class="px-4 pl-[max(1rem,env(safe-area-inset-left))] pr-[max(1rem,env(safe-area-inset-right))] pb-[calc(3rem+var(--safe-area-bottom,env(safe-area-inset-bottom)))] lg:pb-0">
